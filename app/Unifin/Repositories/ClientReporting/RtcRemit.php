...
class RtcRemit implements ReportInterface
{
    ...
    public function generateReport($request) 
    {
        ...
        $data = DB::connection('sqlsrv2')
                ...
                ->select(DB::raw("DBR_CLI_REF_NO, DBR_NAME1, DBR.DBR_NO,TRS_AMT, TRS_COMM_AMT, DBR_STATUS, TRS_TRX_DATE_O, DBR_PRINCIPAL_DUE, TRS_TRUST_CODE "))
                
                ->whereRaw('DBR_CLIENT LIKE ? ', ['RTC%'])
        ...
        $fileName = 'Unifin-Renaissance Remit '. Carbon::now()->format('m-d-Y') . '.xlsx';
