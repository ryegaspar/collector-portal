...
class PendrickIndirectPaymentsMain implements ReportInterface
{
    ...
    public function generateReport($request) 
    {
        ...
        $data = DB::connection('sqlsrv2')
                ...
                ->select(DB::raw("DBR_CLI_REF_NO, DBR_CL_MISC_2, UDW_FLD19, ADR_NAME, UDW_FLD18, TRS_TRX_DATE_O, TRS_AMT, DBR_STATUS, DBR_COM_RATE, DBR_PRINCIPAL_DUE"))
