                        ...
                        <table class="table table-responsive-sm table-bordered table-striped">
                            ...
                            <tbody>
                                <tr v-for="r_data in remapped_data">
                                    ...
                                    <td class="text-right">{{ r_data.this_month_total }}</td>
                                    <td class="text-center">{{ r_data.this_month_count }}</td>
                                    <td class="text-right">{{ r_data.this_month_avg }}</td>
                                    ...
                                    <td class="text-right">{{ r_data.all_total}}</td>
                                    <td class="text-center">{{ r_data.all_count}}</td>
                                    <td class="text-right">{{ r_data.all_avg}}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">{{ sum(thisMonth, 'count') }}</td>
                                    <td class="text-center">{{ sum(thisMonth, 'avg').toFixed(2) }}</td>
                                    ...
                                    <td class="text-center">{{ sum(all, 'count') }}</td>
                                    <td class="text-center">{{ sum(all, 'avg').toFixed(2) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
