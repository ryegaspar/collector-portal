<template>
    <div class="modal fade" id="letterRequestRejectReasonModal" tabindex="-1" role="dialog">
	...
	export default {
		...
		methods: {
			submit() {
				...
				let action = 'patch';
				let notifyMessage = "Successfully changed the status of letter request";
				let url = `/admin/letter-requests/${this.rejectedId}/deny`;
				...
				this.form[action](url)
					.then(() => {
						...
						$("#letterRequestRejectReasonModal").modal('hide');
