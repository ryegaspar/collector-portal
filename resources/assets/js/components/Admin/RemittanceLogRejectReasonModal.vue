<template>
    <div class="modal fade" id="remittanceLogRejectReasonModal" tabindex="-1" role="dialog">
	...
	export default {
		...
		methods: {
			submit() {
				...
				let url = `/admin/remittance-log/${this.rejectedId}/addnotes`;
				...
				this.form[action](url)
					.then(() => {
						...
						$("#remittanceLogRejectReasonModal").modal('hide');
